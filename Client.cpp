...
bool Client::hasUserCommand() const {
    return _hasUserCommand;
}

bool Client::hasNickCommand() const {
    return _hasNickCommand;
}
...
void Client::setHasUserCommand(bool val) {
    _hasUserCommand = val;
}

void Client::setHasNickCommand(bool val) {
    _hasNickCommand = val;
}
